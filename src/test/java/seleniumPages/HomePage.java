...
public class HomePage {
	...
	public void userIsOnHomePage() {
		if (!driver.getCurrentUrl().equalsIgnoreCase("https://www.hotwire.com/")) {
	...
	public void userEntersDepartureReturnDetails(int departDate, String departTime, int returnDate, String returnTime) {
		startDate.clear();
		startDate.sendKeys(HelperUtil.futurdate(departDate));
		startTime.sendKeys(departTime);
		endDate.clear();
		endDate.sendKeys(HelperUtil.futurdate(returnDate));
