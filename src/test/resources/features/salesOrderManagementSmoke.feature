Feature: Smoke test of Maantic Sales Order Management Application
  ...
  @smoke
  Scenario Outline: Create new lead and verify the lead
...
#    Then user verifies new lead "<firstName>", "<lastName>"is populated
    ...
    Examples:
      ...
      | Peter     | Parker_  | Google Inc            | APAD         | HSBC        | Routers - ASR Series              | Shaping    | 4                | Existing | 15                     | Healthcare | West   | Medium         | No              | Appian   | rules@123    |
